...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[3] = UserManager.getInstance().createUser(1000, "user3@semanticsquare.com", "test", "Sarah", "M",
	...
	private static void loadMovies() {
		...
		bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004, "Ikiru", "", 1941,
